...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appointment.bio'
        db.add_column('senate_appointment', 'bio',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Appointment.bio'
        db.delete_column('senate_appointment', 'bio')
    ...
    models = {
        ...
        'senate.appointment': {
            'Meta': {'ordering': "['-end', 'position__sort_order', 'name']", 'object_name': 'Appointment'},
        ...
        'senate.document': {
            'Meta': {'ordering': "['uploaded_at', 'title']", 'object_name': 'Document'},
