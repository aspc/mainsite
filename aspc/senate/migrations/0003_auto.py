...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field groups on 'Position'
        db.create_table('senate_position_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('position', models.ForeignKey(orm['senate.position'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('senate_position_groups', ['position_id', 'group_id'])

    def backwards(self, orm):
        # Removing M2M table for field groups on 'Position'
        db.delete_table('senate_position_groups')
    ...
    models = {
        ...
        'senate.appointment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'position': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['senate.Position']"}),
            'start': ('django.db.models.fields.DateField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'senate.position': {
            'Meta': {'ordering': "['sort_order', 'title']", 'object_name': 'Position'},
