...
class MuddBackend(object):
    ...
    def _get_menu_data(self, week_number):
        ...
        # menu_url = 'https://hmc.sodexomyway.com/images/Week%204%20S15_tcm1300-51951.htm'
        menu_url = 'https://hmc.sodexomyway.com/images/Week%201%20S15_2_tcm1300-52755.htm'
