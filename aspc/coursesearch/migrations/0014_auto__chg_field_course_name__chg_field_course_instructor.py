...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('coursesearch_course', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Course.instructor'
        db.alter_column('coursesearch_course', 'instructor', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'Course.name'
        db.alter_column('coursesearch_course', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Course.instructor'
        db.alter_column('coursesearch_course', 'instructor', self.gf('django.db.models.fields.CharField')(max_length=100))
