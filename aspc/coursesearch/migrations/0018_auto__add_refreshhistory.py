...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RefreshHistory'
        db.create_table('coursesearch_refreshhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('run_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('last_refresh_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('term', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('coursesearch', ['RefreshHistory'])


    def backwards(self, orm):
        
        # Deleting model 'RefreshHistory'
        db.delete_table('coursesearch_refreshhistory')
