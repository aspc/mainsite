...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('coursesearch_course', 'number', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.number'
        db.delete_column('coursesearch_course', 'number')
