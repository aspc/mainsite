...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Course', fields ['cx_code']
        db.create_unique('coursesearch_course', ['cx_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Course', fields ['cx_code']
        db.delete_unique('coursesearch_course', ['cx_code'])
