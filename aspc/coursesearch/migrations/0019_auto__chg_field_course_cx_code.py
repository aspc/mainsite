...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.cx_code'
        db.alter_column('coursesearch_course', 'cx_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))
    def backwards(self, orm):

        # Changing field 'Course.cx_code'
        db.alter_column('coursesearch_course', 'cx_code', self.gf('django.db.models.fields.CharField')(max_length=34, unique=True))
    models = {
        'coursesearch.course': {
