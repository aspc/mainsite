...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding '?' option to check constraint on 'Meeting.campus'
        db.alter_column(
            'coursesearch_meeting',
            'campus',
        ...
        # Adding '?' option to check constraint on 'RequirementArea.campus'
        db.alter_column(
            'coursesearch_requirementarea',
            'campus',
            models.PositiveSmallIntegerField(choices=(
                (1, u'PO'),
                (2, u'SC'),
    ...
    def backwards(self, orm):
        ...
        # Removing '?' option from check constraint on 'Meeting.campus'
        db.alter_column(
            'coursesearch_meeting',
            'campus',
            models.PositiveSmallIntegerField(choices=(
        ...
        # Removing '?' option from check constraint on 'RequirementArea.campus'
        db.alter_column(
            'coursesearch_requirementarea',
            'campus',
            models.PositiveSmallIntegerField(choices=(
