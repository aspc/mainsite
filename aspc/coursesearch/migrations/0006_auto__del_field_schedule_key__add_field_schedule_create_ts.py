...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Schedule.key'
        db.delete_column('coursesearch_schedule', 'key')

        # Adding field 'Schedule.create_ts'
        db.add_column('coursesearch_schedule', 'create_ts', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Schedule.key'
        db.add_column('coursesearch_schedule', 'key', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Deleting field 'Schedule.create_ts'
        db.delete_column('coursesearch_schedule', 'create_ts')
