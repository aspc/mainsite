...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coursesearch_schedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('coursesearch', ['Schedule'])

        # Adding M2M table for field courses on 'Schedule'
        db.create_table('coursesearch_schedule_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('schedule', models.ForeignKey(orm['coursesearch.schedule'], null=False)),
            ('course', models.ForeignKey(orm['coursesearch.course'], null=False))
        ))
        db.create_unique('coursesearch_schedule_courses', ['schedule_id', 'course_id'])


    def backwards(self, orm):
        
        # Deleting model 'Schedule'
        db.delete_table('coursesearch_schedule')

        # Removing M2M table for field courses on 'Schedule'
        db.delete_table('coursesearch_schedule_courses')
