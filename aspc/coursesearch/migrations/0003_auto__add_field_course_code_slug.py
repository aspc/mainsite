...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.code_slug'
        db.add_column('coursesearch_course', 'code_slug', self.gf('django.db.models.fields.CharField')(default='_', unique=True, max_length=20, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.code_slug'
        db.delete_column('coursesearch_course', 'code_slug')
