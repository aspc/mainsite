...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.filled'
        db.add_column('coursesearch_course', 'filled', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.filled'
        db.delete_column('coursesearch_course', 'filled')
