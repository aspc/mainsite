...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.grading_style'
        db.alter_column('coursesearch_course', 'grading_style', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Course.grading_style'
        db.alter_column('coursesearch_course', 'grading_style', self.gf('django.db.models.fields.CharField')(max_length=100))
