...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['senate.Appointment'])),
    ...
    models = {
        ...
        'blog.post': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['senate.Appointment']"}),
