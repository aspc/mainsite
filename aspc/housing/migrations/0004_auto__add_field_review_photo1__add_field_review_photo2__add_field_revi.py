...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.photo1'
        db.add_column('housing_review', 'photo1',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Review.photo2'
        db.add_column('housing_review', 'photo2',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Review.photo3'
        db.add_column('housing_review', 'photo3',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Review.photo1'
        db.delete_column('housing_review', 'photo1')

        # Deleting field 'Review.photo2'
        db.delete_column('housing_review', 'photo2')

        # Deleting field 'Review.photo3'
        db.delete_column('housing_review', 'photo3')
    ...
    models = {
        ...
        'housing.review': {
            ...
            'photo3': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
